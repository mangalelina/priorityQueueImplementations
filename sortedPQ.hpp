...
class SortedPQ : public foundationPQ<TYPE, COMP_FUNCTOR> {
    // This is a way to refer to the base class object.
    using BaseClass = foundationPQ<TYPE, COMP_FUNCTOR>;
...
public:
    ...
    virtual void push(const TYPE &val) {
        auto itr = lower_bound(data.begin(), data.end(), val, this->compare);
        data.insert(itr, val);
    } // push()
